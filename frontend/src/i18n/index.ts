/**
 * @file  i18n/index.ts
 * @desc  Lightweight i18n system (FR / EN) — no external library needed.
 *
 ...
 *   t('nav.vehicles') // → "Véhicules" or "Vehicles"
 */
...
const translations = {
  fr: {
    ...
    'auth.reset.invalid.body':    'Ce lien de réinitialisation est invalide ou a expiré (validité : 1 heure).',
    ...
    // Résultats — pluriel géré dans le composant
    ...
    'admin.add_vehicle':          'Ajouter un véhicule',
...
/**
 * Hook fournissant la fonction de traduction et le sélecteur de langue.
 *
 * @example
 *   const { t, lang, setLang } = useTranslation();
